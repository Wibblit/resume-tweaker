...
export default function TermsOfService() {
 ...
 <div>
  ...
  <div>
   ...
   <span>
    in
    US Dollar, Euro, Pound Sterling, Argentine Peso, Australian Dollar, Brazilian Real,
                    Canadian Dollar, Swiss Franc, Chinese Yuan, Colombian Peso, Czech Koruna, Danish Krone, Hong Kong
                    Dollar, Hungarian Forint, Israeli Shekel, Indian Rupee, Japanese Yen, South Korean Won, Mexican
                    Peso, Norwegian Krone, New Zealand Dollar, Polish Zloty, Russian Ruble, Swedish Krona, Singapore
                    Dollar, Thai Baht, Turkish Lira, New Taiwan Dollar, Ukrainian Hryvnia, Vietnamese Dong, South
                    African Rand
    .
   </span>
  </div>
   ...
   <div>
    <div>
     ...
     <ul>
      ...
      <li>
       <span>
        Use the Services to create resumes, cover letters, or other
                                    materials that include false or exaggerated qualifications, work experience, or
                                    skills.
       </span>
      </li>
      <li>
       <span>
        Repeatedly use AI features in a manner that overloads the system
                                    or attempts to generate inappropriate, offensive, or nonsensical content.
       </span>
      </li>
      <li>
       <span>
        Share or distribute content generated using paid features with
                                    others without authorization.
       </span>
      </li>
      <li>
       <span>
        Sell, resell, or distribute resumes, cover letters, or other
                                    materials created on the platform to third parties.
       </span>
      </li>
      <li>
       <span>
        Use the Services to create or submit applications for illegal,
                                    fraudulent, or deceptive job opportunities.
       </span>
      </li>
      <li>
       <span>
        Upload or incorporate copyrighted text or designs into resumes,
                                    cover letters, or other materials without proper authorization.
       </span>
      </li>
      <li>
       <span>
        Use the Services to create resumes or cover letters intended for
                                    mass distribution or spamming job platforms.
       </span>
      </li>
      <li>
       <span>
        Post fake reviews or testimonials about the Services to mislead
                                    other users or harm competitors.
       </span>
      </li>
      <li>
       <span>
        Remove branding or attribution from templates or designs provided
                                    by the platform and claim them as your own.
       </span>
      </li>
      <li>
       <span>
        Store sensitive or prohibited information in resume or cover
                                    letter fields.
       </span>
      </li>
      <li>
       <span>
        Use the AI customization tools to generate discriminatory,
                                    offensive, or otherwise inappropriate content.
       </span>
      </li>
      <li>
       <span>
        Submit inaccurate or misleading feedback for services or interview
                                    preparation tools to manipulate ratings or harm others.
       </span>
      </li>
      <li>
       <span>
        Attempt to manipulate or bypass the credit-based system for using
                                    paid features without authorization.
       </span>
      </li>
      <li>
       <span>
        Exploit the lifetime storage feature by uploading excessive or
                                    irrelevant files not related to resumes or cover letters.
       </span>
      </li>
      <li>
       <span>
        Use the interview preparation tools to create responses intended
                                    for unethical or illegal behavior during interviews.
       </span>
      </li>
      <li>
       <span>
        Use the Services to store or share private or confidential
                                    information of third parties without their consent.
       </span>
      </li>
      <li>
       <span>
        Create multiple accounts to exploit free features or bypass credit
                                    requirements.
       </span>
      </li>
      <li>
       <span>
        Register accounts in bulk for resale, fraud, or misuse of platform
                                    resources.
       </span>
      </li>
      <li>
       <span>
        Use the platform-generated materials to engage in unsolicited bulk
                                    communication or job application spamming on external websites.
       </span>
      </li>
      <li>
       <span>
        Attempt to extract, copy, or aggregate user data from resumes or
                                    cover letters for any purpose without explicit consent.
       </span>
      </li>
     </ul>
     <div>
 ...
 <div>
  <span>
   We care about data privacy and
            security. By using the Services, you agree to be bound by our Privacy Policy posted on the Services, which
