...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://resumetweaker.vercel.app/legal/refund-policy",
  },
};
        ...
        <div className="p-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              All <strong className="text-foreground">successful sales</strong>{" "}
              are final and no refund will be issued.
            </p>
            ...
            <p className="text-muted-foreground mb-4">
              A successful sale is defined as a completed transaction where
              payment has been processed and access to the purchased product or
              service has been granted. This includes, but is not limited to:
            </p>
            <ul className="list-disc list-inside text-muted-foreground mb-4 space-y-2">
              <li>Credits successfully added to your account</li>
              <li>Access provided to purchased features or services</li>
              <li>
                No payment disputes or cancellations during the transaction
                process
              </li>
            </ul>
            ...
            <p className="text-muted-foreground mb-4">
              If a transaction fails due to technical issues or incomplete
              payment, it will not be considered a successful sale. Please
              contact us at{" "}
              <a
            ...
            <div className="space-y-4">
              <p className="text-muted-foreground">
                ...
                You purchase 100 credits, payment is processed, and credits are
              ...
              <p className="text-muted-foreground">
                ...
                You attempt a payment, but the transaction is declined or
                credits are not added due to an error.
              </p>
            </div>
          </div>
