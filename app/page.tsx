...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://resumetweaker.vercel.app",
  },
  keywords: [
    "AI resume builder",
    "resume maker",
  ...
  const faqData = [
    {
      ...
      answer:
        "ResumeTweaker's AI-powered interview tool helps you prepare with voice-based mock interviews, real-time feedback, and adaptive question flows tailored to your target job role.",
    },
    {
      question: "Can AI help me review my interview performance?",
      answer:
        "Yes! ResumeTweaker analyzes your interview responses, evaluates clarity, tone, and key content, and offers personalized tips to improve your chances of success.",
    },
    {
      question: "How does ResumeTweaker's credit-based pricing work?",
      answer:
        "ResumeTweaker uses a transparent credit-based system. You only pay for what you use — whether that’s resume building, cover letter generation, or interview practice. No hidden fees!",
    },
    {
      question: "Is my data safe with ResumeTweaker?",
      answer:
        "Absolutely. ResumeTweaker uses secure encryption and never stores your personal data without consent. Your documents are yours, and privacy is our priority.",
    },
    {
      question: "Can AI help me write a strong resume?",
      answer:
        "Definitely! ResumeTweaker's AI crafts resumes tailored to your skills and job goals, optimizes for ATS scans, and suggests improvements to maximize impact.",
    },
    {
      question: "How do I write a cover letter that stands out?",
      answer:
        "ResumeTweaker helps you write compelling cover letters by highlighting your achievements, aligning with the job description, and structuring everything professionally.",
    },
  ];
