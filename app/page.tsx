  ...
  const faqData = [
    {
      ...
      answer:
        "ResumeTweaker is an AI-powered tool designed to help you create, improve, and optimize your resumes and cover letters. Simply upload your existing resume or provide details about your skills and job history, and ResumeTweaker will generate professional, ATS-friendly documents tailored to your desired job. ",
    },
    {
      question:
        "2. Can ResumeTweaker review my resume for specific job applications?",
      answer:
