...
//             <h1 className="text-3xl font-bold uppercase mb-1 text-center">{basics.name}</h1>
...
//         return (
//           <section className="mb-6">
//             {/* <h2 className="border-none" style={styles.sectionTitleWithOutBorder}>Profiles</h2> */}
