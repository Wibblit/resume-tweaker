                                  ...
                                  >
                                    <AccordionTrigger className="px-4 py-2 hover:bg-muted/30">
                                      <div className="flex items-center justify-between w-full">
                                        ...
                                        <Badge variant="outline" className="ml-2">
                                          {Array.isArray(issue.metrics) ? issue.metrics.reduce((count, metric) => count + metric.issues.length, 0) : 0}{" "}
                                          issues
                                        </Badge>
                                      </div>
                                    </AccordionTrigger>
                                    <AccordionContent className="bg-muted/10 p-4">
                                      <div className="space-y-4">
                                        {Array.isArray(issue.metrics) && issue.metrics.map((metric, metricIndex) => (
