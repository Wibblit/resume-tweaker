...
export default function InterviewProcess({
  ...
  const submitAnswer = () => {
    const newHistoryItem: HistoryItem = {
      ...
      answer: recognizedText, // Use recognizedText instead of userAnswer
    }
  ...
  const generateReport = async () => {
    ...
    try {
      // Add the last question and answer to the history before generating the report
      const finalHistory = [
        ...history,
        {
          question: questions[currentQuestionIndex],
          answer: recognizedText || "Skipped", // Use recognizedText instead of userAnswer
        },
      ]
