...
const bundleNames = {200:"Starter",500:"Essential",1000:"Power",2000:"Super Saver"};
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={chartData} >
                      ...
                      <Bar 
                        ...
                        radius={[4, 4, 4, 4]}
                      >
                        <LabelList dataKey="costAdjusted" position="top" fill="hsl(var(--foreground))"  formatter={(value:any) => `${value} credits`}  />
                        </Bar>
                    </BarChart>
                  </ResponsiveContainer>
                </div>
