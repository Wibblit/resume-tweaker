...
function LoadingText({ value, currencyCode }: LoadingTextProps) {
  if (value === undefined) {
    return <Skeleton className="h-[20px] w-[75px] bg-muted" />;
  } else {
    return formatMoney(value, currencyCode);
  }
}
...
export function CheckoutLineItems({
  ...
  return (
    <>
      <div className="md:pt-12 text-base leading-[20px] font-medium text-foreground">
      ...
      <div className="pt-6 flex justify-between">
        ...
        <span className="text-base leading-[20px] font-semibold text-foreground">
          <LoadingText
