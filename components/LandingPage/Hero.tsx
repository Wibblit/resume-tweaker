      ...
      <div className="container max-w-7xl mx-auto px-4 py-16 flex flex-col lg:flex-row items-center justify-between z-10 gap-8">
        ...
        >
          <div className="relative w-[300px] h-[400px] [transform-style:preserve-3d] animate-slow-spin">
                ...
                <div className="absolute inset-0 bg-zinc-100 dark:bg-zinc-800 rounded-lg shadow-xl overflow-hidden flex flex-col">
                  ...
                  <div className="p-4 space-y-3 flex-grow overflow-auto">
                    <div>
                      ...
                      <p className="text-[10px] text-muted-foreground line-clamp-1">A Registered Nurse with 8 years of experience delivering quality healthcare services to diverse patient populations...</p>
                    </div>
                    <div>
                      <h4 className="text-xs font-semibold mb-1">Experience</h4>
                      <div className="space-y-1">
                        <div>
                          <p className="text-[10px] font-medium">Senior Nurse - City Hospital</p>
                          <p className="text-[10px] text-muted-foreground">2018 - Present</p>
                        </div>
                        <div>
                          <p className="text-[10px] font-medium">Registered Nurse - Community Clinic</p>
                          <p className="text-[10px] text-muted-foreground">2015 - 2018</p>
                        </div>
                      </div>
                    </div>
                    <div>
            ...
            <div className="absolute top-32 -left-28 w-48 h-32 [transform:rotateX(10deg) rotateY(-10deg)] [transform-style:preserve-3d]">
              <div className="absolute inset-0 bg-zinc-100/30 dark:bg-zinc-700/30 backdrop-blur-md rounded-lg shadow-lg p-4">
                ...
                <p className="text-xs text-muted-foreground">AI-powered skill assessment and recommendations</p>
              </div>
            </div>
            <div className="absolute -bottom-10 -right-10 w-48 h-36 [transform:rotateX(-10deg) rotateY(10deg)] [transform-style:preserve-3d]">
              <div className="absolute inset-0 bg-zinc-100/30 dark:bg-zinc-700/30 backdrop-blur-md rounded-lg shadow-lg p-4">
                ...
                <p className="text-xs text-muted-foreground">Choose from a variety of professional designs</p>
