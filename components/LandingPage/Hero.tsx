      ...
      <div className="container mx-auto px-4 py-8 flex flex-col items-center justify-center text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button variant="outline" className="w-full sm:w-auto group border-input hover:bg-accent hover:text-accent-foreground hover:cursor-pointer">
              View Templates
          ...
          <div className="flex flex-col sm:flex-row gap-8 justify-center mt-12">
            <div className="text-center">
              <h3 className="text-4xl font-bold text-foreground">38%</h3>
              <p className="text-muted-foreground">more interviews</p>
            </div>
            <div className="text-center">
              <h3 className="text-4xl font-bold text-foreground">23%</h3>
