...
const components: { title: string; href: string; description: string }[] = [
  ...
  },
  {
    ...
    description: "Tips and strategies to advance your career and land your dream job.",
  },
  {
  ...
  },
  {
    ...
    description: "Prepare for your next interview with our expert advice and strategies.",
  },
]
          ...
          <NavigationMenuContent>
            <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              ...
              <ListItem href="#" title="Resume Templates">
                ...
                Professionally designed, customizable resume templates to help you stand out.
              </ListItem>
              <ListItem href="#" title="AI Resume Analyzer">
                <Activity size={16} className="inline-block mr-2" />
                Analyze your resume with AI to get real-time feedback and optimization tips.
              </ListItem>
              <ListItem href="#" title="AI-Powered Resume Editor">
                <Edit3 size={16} className="inline-block mr-2" />
                Create, edit, and personalize your resume with our advanced, AI-driven tools.
              </ListItem>
            </ul>
          </NavigationMenuContent>
        </NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              <li className="row-span-3">
                <NavigationMenuLink asChild>
                  ...
                  >
                    ...
                    <p className="text-sm leading-tight text-muted-foreground">
                      Craft a compelling cover letter effortlessly with AI. Tailor your content and create a persuasive narrative that showcases your strengths.
                    </p>
                  </a>
                </NavigationMenuLink>
              </li>
              <ListItem href="#" title="Cover Letter Templates">
                <FileText size={16} className="inline-block mr-2" />
                Customizable cover letter templates to help you make a strong first impression.
              </ListItem>
              <ListItem href="#" title="AI-Integrated Cover Letter Editor">
                <Edit3 size={16} className="inline-block mr-2" />
                Create, edit, and personalize your cover letter with our AI-powered editor.
              </ListItem>
            </ul>
          </NavigationMenuContent>
        </NavigationMenuItem>
              ...
              <li className="md:col-span-2">
                <NavigationMenuLink asChild>
                  <a
                    ...
                    href="/blogs"
                  >
                    <div className="text-sm font-medium leading-none">See All Blogs</div>
                    <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                      <BookOpen size={16} className="inline-block mr-2" />
                      Explore our full collection of articles, tips, and insights.
                    </p>
                  </a>
                </NavigationMenuLink>
              </li>
